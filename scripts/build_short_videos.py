...
def main():
    ...
    if len(items)>=minimum:
        ...
        section='<section class="short-videos wrap" aria-labelledby="short-video-title"><div class="short-videos__head"><h2 id="short-video-title">Du store verden</h2><p>Nyheder, natur, sport, teknologi og øjeblikke værd at se.</p></div><div class="short-videos__rail">'+''.join(cards)+'</div></section><dialog class="video-dialog" id="short-video-dialog"><button class="video-dialog__close" type="button" aria-label="Luk video">×</button><div class="video-dialog__frame"></div></dialog><script src="short-videos.js" defer></script>'
