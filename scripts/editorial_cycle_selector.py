#!/usr/bin/env python3
"""Cheap GitHub-side cycle selector that avoids unnecessary Workers AI editorial calls.

This selector is deliberately advisory/fail-open. Cloudflare remains the source of truth
...
def self_test() -> None:
    ...
    print("editorial_cycle_selector self-test: PASS")
