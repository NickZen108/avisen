...
## Skal læse
`HUSREGLER.md`, `EDITORIAL.md`, `SOURCES.md`, `SCAN.md`, `SCHEDULE.md`.

## Input
`scan/latest.md`, web/feeds/officielle kilder, eksisterende story ids og seneste live-artikler.
...
## Forbud
Ingen artikelprosa. Ingen publicering. Ingen breaking-konklusion alene fordi to URLs findes. Ingen fyld.
