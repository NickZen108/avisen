...
async function runResearch(env, assignment, selected) {
  ...
  // Research always supplements the start source/link expansion with a fresh,
...
async function runFactCheck(env, assignment, research, article) {
